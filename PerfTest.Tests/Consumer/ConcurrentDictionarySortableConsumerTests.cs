...
{
    public class ConcurrentDictionarySortableConsumerTests
    {
        private ConcurrentDictionarySortableConsumer _consumer;

        [SetUp]
        public void SetUp()
        {
            _consumer = new ConcurrentDictionarySortableConsumer();
        }
